...
const Card = ({ product }) => {
    ...
    const { navigate, addToCart, removeCart, updateCart, cartItems } = useAppContext()
                ...
                <div className="flex items-end justify-between mt-3">
                    ...
                    <div onClick={(e) => e.stopPropagation()} className="text-primary">
                        {!cartItems[product._id] ? (
                            <button className="flex items-center justify-center cursor-pointer gap-1 bg-primary/10 border border-primary/40 md:w-[80px] w-[64px] h-[34px] rounded text-primary font-medium" onClick={() => addToCart(product._id)} >
